...
async def lifespan(app: FastAPI):
    ...
    app.todo_dal = ToDoList(todo_lists)
...
app = FastAPI(lifespan=lifespan, debub=DEBUG)
...
async def delete_items(list_id: str, item_id: str) -> ToDoList:
...
async def set_checked_state(list_id: str, update: ToDoItemUpdate) -> ToDoList:
    return await app.todo_dal.set_checked(
